...
class StoreSubmissionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'member_4' => ['nullable', 'string', 'max:100'],
            'member_5' => ['nullable', 'string', 'max:100'],
            'member_6' => ['nullable', 'string', 'max:100'],
            'member_7' => ['nullable', 'string', 'max:100'],
            'member_8' => ['nullable', 'string', 'max:100'],
            'member_9' => ['nullable', 'string', 'max:100'],
            'member_10' => ['nullable', 'string', 'max:100'],
